...
public class Cliente extends User {
    ...
    private List<Producto> productosPublicados;  // Lista de productos que el cliente ha publicado
    ...
    public Cliente(int id, String nombre, String apellido, String correoElectronico, String telefono, String direccion, String rol) {
        ...
        this.productosPublicados = new ArrayList<>(); // Inicializa la lista de productos publicados
    }

    // Método para publicar un producto
